...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_win1_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(166, 18) // "SendDataPeriodSlot"
    ...
    "win1\0DatatoCRC_signal\0\0QByteArray&\0"
    "SendData\0findSerialPort\0OpenSerialPortSlot\0"
    "RxDataSaveSlot\0RxDataTextClearSlot\0"
    "DataReadyReadSlot\0SendDataSlot\0"
    "SendDataTextClearSlot\0SendDataPeriodSlot"
};
...
void win1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&win1::DatatoCRC_signal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject win1::staticMetaObject = { {
    ...
    qt_meta_stringdata_win1.offsetsAndSize,
    qt_meta_data_win1,
    qt_static_metacall,
    nullptr,
